...
let filterOptions = [{ filterName: 'Sort by popularity' }, { filterName: 'Sort by average rating' }, { filterName: 'Sort by latest' }, { filterName: 'Sort by price: low to high' }, { filterName: 'Sort by price: high to low' }];
